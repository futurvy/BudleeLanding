      ...
      <main className="flex-grow py-16 md:py-5 px-4 md:px-12 lg:px-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">1. What Are Cookies?</h2>
            <p className="mb-6">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">2. How We Use Cookies</h2>
            <p className="mb-4">
              We use cookies to:
            </p>
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">3. Types of Cookies We Use</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">4. Third-Party Cookies</h2>
            <p className="mb-6">
              We may use third-party services (e.g., analytics providers) that set their own cookies. We do not control these cookies.
            </p>

            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">5. Managing Cookies</h2>
            <p className="mb-6">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">6. Your Consent</h2>
            <p className="mb-6">
              By using our Service, you consent to our use of cookies. You can withdraw consent by adjusting your settings.
            </p>

            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">7. Updates to This Policy</h2>
            <p className="mb-6">
              We may update this Policy. Significant changes will be communicated.
            </p>

            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">8. Contact Us</h2>
            <div className="mb-6">
