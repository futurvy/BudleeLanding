      ...
      <main className="flex-grow py-16 md:py-5 px-4 md:px-12 lg:px-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">2. Refund Eligibility</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">3. Cancellation Policy</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">4. Payment Processing</h2>
            <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">5. Exceptions</h2>
            <p className="mb-6">
              Refunds may be considered in rare cases of technical errors on our end, at our sole discretion.
            </p>

            <h2 className="hero-tagline text-2xl md:text-3xl lg:text-[32px] mb-8 md:mb-10 whitespace-nowrap gradient-text mt-8">6. Contact Us</h2>
            <div className="mb-6">
