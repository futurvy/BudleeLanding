...
const AppDownloadSection = () => {
  return (
    <section className="w-full bg-white pt-10 pb-2 px-4 md:px-12 lg:px-20 relative overflow-hidden">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
        ...
        <div className="text-center md:text-left relative z-10">
          ...
          <p className="text-gray-600 text-lg font-medium">
            Learn anything, anywhere. Available on all your devices.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 relative z-10">
          <a 
            ...
            className="transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl rounded-[12px] overflow-hidden"
          >
            <img 
          ...
          >
            <img 
              ...
              className="h-12 md:h-16 bg-black p-[1px]"
            />
          </a>
        </div>
      </div>
